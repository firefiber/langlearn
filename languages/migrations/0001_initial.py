    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(choices=[('L', 'Learning'), ('N', 'Native'), ('B', 'Both')], default='B', max_length=1)),
            ],
        ),
        migrations.CreateModel(
            name='SentenceType',
        ...
        migrations.AddIndex(
            model_name='word',
            index=models.Index(fields=['word_item'], name='languages_w_word_it_94c2cf_idx'),
        ),
        migrations.AddIndex(
